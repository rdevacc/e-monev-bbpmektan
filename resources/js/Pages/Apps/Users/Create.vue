<template>
    <Head>
        <title>Add New User | E-Monev BBP Mektan</title>
    </Head>
    <main class="c-main">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="mb-3">
                                                ...
                                                <br>
                                                <select v-model="form.field_id" class="form-select col-md-5">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="mb-3">
                                                ...
                                                <br>
                                                <select v-model="form.group_id" class="form-select col-md-5">
                                                    <option disabled value="">Please select one</option>
