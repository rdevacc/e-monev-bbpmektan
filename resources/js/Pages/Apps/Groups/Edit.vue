<template>
    <Head>
        <title>Edit Groups | E-Monev BBP Mektan</title>
    </Head>
    <main class="c-main">
                    ...
                    <div class="col-md-12">
                        <div class="card border-0 rounded-3 shadow border-top-purple">
                            <div class="card-header">
                                <span class="font-weight-bold"><i class="fa fa-user"></i> Edit Group</span>
                            </div>
                            <div class="card-body">
...
export default {
    ...
    setup(props) {
        ...
        const submit = () => {
            ...
            //send data to server
            form.put(`/apps/groups/${props.group.id}`, {
                //data
