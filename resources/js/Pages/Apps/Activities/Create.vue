<template>
    <Head>
        <title>Tambah Kegiatan Baru | E-Monev BBP Mektan</title>
    </Head>
    <main class="c-main">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <!-- <input v-model="financial_realization" type="number"
                                        ...
                                        <div class="col-12">
                                            <div class="mb-3">
                                                ...
                                                <div v-if="hasAnyPermission(['activities.delete'])"
                                                    class="input-group mb-3">
                                                    <span class="input-group-text">Target</span>
                                                    <!-- <input v-model="physical_target" type="number" class="form-control"
                                                        placeholder="Rp."> -->
                                                ...
                                                <div class="input-group mb-3">
                                                    <span class="input-group-text">Realisasi</span>
                                                    <!-- <input v-model="physical_realization" type="number" class="form-control"
                                                        placeholder="Rp."> -->
                                                    <Money3Component class="form-control"
...
export default {
    ...
    setup(props) {
        ...
        const budgetPJ = ref(0);
        const financial_target = ref(0);
        const financial_realization = ref(0);
        const physical_target = ref(0);
        const physical_realization = ref(0);
        const dones = reactive([
            { value: '' },
        ])
        const problems = reactive([
            { value: '' },
        ])
        const follow_up = reactive([
            { value: '' },
        ])
