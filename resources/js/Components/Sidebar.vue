<template>
    <ul class="c-sidebar-nav">
        ...
        <li class="c-sidebar-nav-item">
            <Link class="c-sidebar-nav-link" :class="{ 'active': $page.url.startsWith('/apps/dashboard') }"
                href="/apps/dashboard">
        ...
        <li class="c-sidebar-nav-title" v-if="hasAnyPermission(['activities.index'])">KEGIATAN</li>

        <li class="c-sidebar-nav-item" v-if="hasAnyPermission(['activities.index'])">
            <Link class="c-sidebar-nav-link" href="/apps/activities"
                :class="{ 'active': $page.url.startsWith('/apps/activities') }">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clipboard-data"
                viewBox="0 0 16 16">
                <path
        ...
        <li class="c-sidebar-nav-title" v-if="hasAnyPermission(['fields.index']) || hasAnyPermission(['groups.index'])">
            MASTER</li>
        <li class="c-sidebar-nav-item" v-if="hasAnyPermission(['fields.index'])">
            <Link class="c-sidebar-nav-link" href="/apps/fields"
                :class="{ 'active': $page.url.startsWith('/apps/fields') }">
            ...
            <span class="ms-2">Kelompok</span>
            </Link>
        </li>

        <li class="c-sidebar-nav-item" v-if="hasAnyPermission(['groups.index'])">
            <Link class="c-sidebar-nav-link" href="/apps/groups"
                :class="{ 'active': $page.url.startsWith('/apps/groups') }">
            ...
            <span class="ms-2">Subkelompok</span>
            </Link>
        </li>
